...
<table class="style">
    ...
    <tr>
        ...
        <form action="${var}" method="post">
            <td>
                <p style="color: black">${katet.getId()}</p>
                <input type="hidden" class="w3-input" value="${katet.getId()}" name="id" >
            </td>
            <td>
                <p style="color: black">${katet.getSeam()}</p>
                <input type="hidden" class="w3-input" value="${katet.getSeam()}" name="seam" >
            </td>
            <td><input class="w3-input" type="number" value="${katet.getK()}" name="k" required="required"></td>
            <td><input class="w3-input" type="number" step="0.001" value="${katet.getKoef()}" name="koef" required="required"></td>
